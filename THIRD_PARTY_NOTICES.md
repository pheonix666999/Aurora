...
|---|---:|---|---|
| JUCE | 8.0.14 (`2cdfca8...`) | Application, VST3, Audio Unit, DSP, GUI, test primitives | JUCE commercial licence or AGPLv3; product owner must select an applicable licence |
...
| Xcode and Apple command-line tools | GitHub `macos-15` runner image | macOS compiler, ad-hoc signing, Universal-binary and DMG tools | Build-time Apple terms |
| Inno Setup | 6.7.1 | Installer | Build-time; see Inno Setup licence |
