...
5. Push the branch.
6. Confirm Windows CI and macOS CI succeed.
7. Create `vX.Y.Z` at that exact commit.
8. Push the tag.
9. Wait for Build Cross-Platform Release; both platform jobs must succeed.
10. Review tests and diagnostics.
11. Review validator status honestly.
12. Download, checksum, inspect, and install both platform package sets.
